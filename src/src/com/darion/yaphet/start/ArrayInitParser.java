...
public class ArrayInitParser extends Parser {
    ...
    public static final int T__0 = 1, T__1 = 2, T__2 = 3, INT = 4, WS = 5;
    public static final int RULE_init = 0, RULE_value = 1;
    public static final String[] ruleNames = {"init", "value"};

    private static final String[] _LITERAL_NAMES = {null, "'{'", "','", "'}'"};
    private static final String[] _SYMBOLIC_NAMES = {null, null, null, null, "INT", "WS"};
    ...
    public static class InitContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ArrayInitListener)
                ((ArrayInitListener) listener).enterInit(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ArrayInitListener)
                ((ArrayInitListener) listener).exitInit(this);
        }
    }
    ...
    public static class ValueContext extends ParserRuleContext {
        ...
        public void enterRule(ParseTreeListener listener) {
            if (listener instanceof ArrayInitListener)
                ((ArrayInitListener) listener).enterValue(this);
        }

        @Override
        public void exitRule(ParseTreeListener listener) {
            if (listener instanceof ArrayInitListener)
                ((ArrayInitListener) listener).exitValue(this);
        }
    }
    ...
    public static final String _serializedATN = "\3\u0430\ud6d1\u8206\uad2d\u4417\uaef1\u8d80\uaadd\3\7\26\4\2\t\2\4\3"
